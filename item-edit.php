...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="<?php echo str_replace('_', '-', osc_current_user_locale()); ?>">
    ...
    <body>
        ...
        <div class="content add_item">
            <h1><strong><?php _e('Update your listing', 'summersday'); ?></strong></h1>
            <ul id="error_list"></ul>
                ...
                <fieldset>
                    ...
                    <input type="hidden" name="secret" value="<?php echo osc_item_secret();?>" />
                        <div class="box general_info">
                            ...
                            <div class="row">
                                <label><?php _e('Category', 'summersday'); ?> *</label>
                                <?php ItemForm::category_select(null, null, __('Select a category', 'summersday')); ?>
                            </div>
                            <div class="row">
                            ...
                            <div class="row price">
                                <label><?php _e('Price', 'summersday'); ?></label>
                        ...
                        <div class="box location">
                            <h2><?php _e('Location', 'summersday'); ?></h2>
                            <div class="row">
                                <label><?php _e('Country', 'summersday'); ?></label>
                                <?php ItemForm::country_select(); ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Region', 'summersday'); ?></label>
                                <?php ItemForm::region_text(); ?>
                            </div>
                            <div class="row">
                                <label><?php _e('City', 'summersday'); ?></label>
                                <?php ItemForm::city_text(); ?>
                            </div>
                            <div class="row">
                                <label><?php _e('City area', 'summersday'); ?></label>
                                <?php ItemForm::city_area_text(); ?>
                            </div>
                            <div class="row">
                                <label><?php _e('Address', 'summersday'); ?></label>
                        ...
                        <?php }?>
                    <button class="itemFormButton" type="submit"><?php _e('Update', 'summersday'); ?></button>
                    <a href="javascript:history.back(-1)" class="go_back"><?php _e('Cancel', 'summersday'); ?></a>
                </fieldset>
            </form>
        </div>
