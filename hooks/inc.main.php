...
<div class="categories <?php echo 'c' . $total_categories; ?>">
    ...
    <?php
        ...
        if(osc_count_categories () > 0) {
            echo '<center><div class="col c1">';
        }
    ?>
    <?php while ( osc_has_categories() ) { ?>
	
        <div class="category">
            <h3><strong><a class="category cat_<?php echo osc_category_id(); ?>" href="<?php echo osc_search_category_url(); ?>"><?php echo osc_category_name(); ?></a> <span class="label label-primary"><?php echo osc_category_total_items(); ?></span></strong></h3>
