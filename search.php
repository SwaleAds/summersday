            ...
            <div id="main">
                <div class="ad_list">
                    ...
                    <?php if(osc_count_items() == 0) { ?>
                        <p class="empty" ><?php printf(__('There are no results matching "%s"', 'summersday'), osc_search_pattern()); ?></p>
                    <?php } else { ?>
                ...
                <div class="filters">
                    <form action="<?php echo osc_base_url(true); ?>" method="get" onsubmit="return doSearch()" class="nocsrf">
                        ...
                        <fieldset class="box location">
                            <h3><strong><?php _e('Your search', 'summersday'); ?></strong></h3>
                            <div class="row one_input">
                                <input type="text" name="sPattern" id="query" value="<?php echo osc_esc_html( osc_search_pattern() ); ?>" />
                                <div id="search-example"></div>
                            </div>
                            <h3><strong><?php _e('Location', 'summersday'); ?></strong></h3>
                            <div class="row one_input">
                                <h6><?php _e('City', 'summersday'); ?></h6>
                        ...
                        <fieldset class="box show_only">
                            ...
                            <h3><strong><?php _e('Show only', 'summersday'); ?></strong></h3>
                            <div class="row checkboxes">
                                <ul>
                                    <li>
                                        <input type="checkbox" name="bPic" id="withPicture" value="1" <?php echo (osc_search_has_pic() ? 'checked="checked"' : ''); ?> />
                                        <label for="withPicture"><?php _e('Show only listings with pictures', 'summersday'); ?></label>
                                    </li>
                                </ul>
                            </div>
                            <?php } ?>
                            ...
                            <?php  if ( osc_count_categories() ) { ?>
                                <div class="row checkboxes">
                                    <h6><?php _e('Category', 'summersday'); ?></h6>
                                    <ul>
                        ...
                        ?>
                        <button type="submit"><?php _e('Apply', 'summersday'); ?></button>
                    </form>
                    <?php osc_alert_form(); ?>
                </div>
            </div>
                ...
                $(function() {
                    ...
                    $( "#sCity" ).autocomplete({
                        ...
                        select: function( event, ui ) {
                            ...
                            log( ui.item ?
                                "<?php _e('Selected', 'summersday'); ?>: " + ui.item.value + " aka " + ui.item.id :
                                "<?php _e('Nothing selected, input was', 'summersday'); ?> " + this.value );
                        }
                    });
                });
